...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    $sql1 = "DELETE FROM courses WHERE COURSE_ID=?";
    mysqli_error($conn);
    if($stmt1 = mysqli_prepare($conn, $sql1))
        mysqli_stmt_bind_param($stmt1, "s",$course_id_to_check);
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <div class="topnavx">
        ...
        <a href="#">/</a>
        <a class="active" href="#"> Delete Course</a>
    </div>
    ...
    <div class="row">
        <div class="left-column">
            ...
            <h1 style="color:#90774f; padding-left: 40px;">Delete Course</h1></div></div>';
...
echo'
    ...
    <form action="" method="post">
        ...
        <input type="text" id="coursename" name="coursename" placeholder="Python For Everybody" value="' .$row['NAME'] .'" autofocus required disabled><br>

        <div class="col-25">
            <label for="course_ID">Course ID:</label></div>
        <input type="text" id="username" name="username" placeholder="10001" value="' .$row['COURSE_ID'] .'" required disabled>
        <span id="Result"></span><br>
        
        <div class="col-25">
            <label for="coursedescription">Course Description:</label></div>
        <input type="text" id="coursedescription" name="coursedescription" placeholder="Very Good" value="' .$row['DESCRIPTION'] .'" required disabled><br>
        <input type="submit" id="submit" value="Delete Course" style="border-radius:20px;
background-color:#1d3056;
margin-left:120px;
margin-top:40px;
margin-bottom:40px;
