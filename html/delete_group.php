...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    mysqli_query($conn,"UPDATE account INNER JOIN group_users ON account.Group_ID = group_users.Group_ID SET account.Group_Name = 'Not in Any Group' WHERE group_users.Group_ID= $user_id_to_check");
    $sql1 = "DELETE FROM group_users WHERE Group_ID=?";
    mysqli_error($conn);
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <div class="topnavx">
        ...
        <a href="#">/</a>
        <a class="active" href="#">Delete Group</a>
    </div>
...
echo'
    ...
    <form action="" method="post">
        ...
        <input type="text" id="username" name="username" placeholder="10001" value="' .$row['Group_ID'] .'" required disabled><br>


        
        <div class="col-25">
            <label for="fname">Group Name:</label></div>

        <input type="text" id="fname" name="fname" placeholder="Aditya" value="' .$row['Group_Name'] .'" autofocus required disabled><br>
