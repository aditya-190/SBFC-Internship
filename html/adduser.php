...
if(mysqli_stmt_execute($stmt1))
 {
   mysqli_stmt_store_result($stmt1);
     ...
     echo '<script type="text/javascript">location.href = "displayuser.php";</script>';
 }
else {
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <form action="" method="post">
        ...
        <input type="text" id="department" name="department" placeholder="Technical Expert" required><br>
        <div class="col-25">
        ...
        <input type="submit" id="submit" value="Add User" style="border-radius:20px;
background-color:#1d3056;
margin-left:120px;
margin-top:40px;
margin-bottom:40px;
