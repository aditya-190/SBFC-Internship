...
{   $group_name = $_POST[username];
    $sql1 = "INSERT INTO group_users (Group_Name) VALUES (?)";
    mysqli_error($conn);
    ...
    if(mysqli_stmt_execute($stmt1))
    {
        ...
        echo '<script type="text/javascript">location.href = "group.php";</script>';
    }
    else {
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <form action="" method="post">
        ...
        <input type="text" id="username" name="username" placeholder="Group Name" required>
